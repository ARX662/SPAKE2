...
public class Client   {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // uncomment start and time_elapsed to find initial file creation time.
        //time for initial file creation
        ...
        if( password.isEmpty()){
            ...
            */
            ...
            // Creating a sub Generator M
            Point M = Generators.g1.multiply(Generators.P, m);
            //Creating  wM and sent to admin
            ...
            // admin checks if session key is valid
            if (sB.equals(sA)) {
            ...
            /*
             // Password user has input
            System.out.println("Password_Client: " +w);
            // T and wM sent to admin
            System.out.println("T_Client: " +T);
            System.out.println("wM_Client: " +wM);
            // reading decrypted data from admin S and wN.
            System.out.println("S_Client: " +S);
            System.out.println("wN_Client: " +wN);
            // Key generated by client.
            System.out.println("Key_Client: " +Ka);
             */
